...
public class ProfileGuestFragment extends Fragment implements MainFragmentInterface {
    ...
    public void onViewCreated(@NonNull View profileView, @Nullable Bundle savedInstanceState) {
        ...
        Button mSigInBtn = profileView.findViewById(R.id.guest_sign_in_btn);
        ...
        mSigInBtn.setOnClickListener(view -> requireActivity().finish());
    ...
    public View.OnClickListener onNavHomeClicked() {
        return view -> {
            NavDirections navDirections = ProfileGuestFragmentDirections.actionProfileGuestFragmentToHomeFragment();
    ...
    public View.OnClickListener onNavSearchClicked() {
        return view -> NavigationUtils.navigateSafe(mNavController, ProfileGuestFragmentDirections.actionProfileGuestFragmentToSearchFragment());
    ...
    public View.OnClickListener onNavWishlistClicked() {
        return view -> {
            NavDirections navDirections = ProfileGuestFragmentDirections.actionProfileGuestFragmentToWishlistGuestFragment();
            NavigationUtils.navigateSafe(mNavController, navDirections);
        };
    }
